...
const COINS = [
  ...
  { id: "chip-2",           symbol: "CHIP",   name: "USD.AI",           tgePrice: 0.03,    tgeDate: "2026-03" },
...
export default function CryptoDashboard() {
    ...
    try {
      ...
      if (missingCoins.length > 0) {
        try {
          ...
          const fbRes = await fetch(CG + "/simple/price?ids=" + mids +
  ...
  const thBase = { padding: "10px 8px", textAlign: "right", fontSize: 11, color: "#6b7280", fontWeight: 600, borderBottom: "2px solid #e5e7eb", whiteSpace: "nowrap", position: "sticky", top: 0, background: "#fff", zIndex: 1 };
